...
class ChatGptPropsPanel : JPanel(BorderLayout()) {
    ...
    private fun initialize() {
        add(buildSettingPanel(), BorderLayout.NORTH)
    ...
    private fun buildOptionalSettingPanel() : JPanel {
        ...
        optionalSettingPanel.add(
            JBLabel(MessageBundle.message("chatgpt.message.setting.optional.label")), GridBagConstraints(0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
            GridBagConstraints.NONE, COMPONENT_INSETS, 0, 0)
        )
